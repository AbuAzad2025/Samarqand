    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white" dir="rtl">
      ...
      <section className="relative bg-gradient-to-r from-[#4A90E2] to-[#5DADE2] text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto">{company?.description || ""}</p>
        </div>
      </section>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#4A90E2] to-[#5DADE2] rounded-full flex items-center justify-center">
